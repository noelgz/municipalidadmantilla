	...
	<?php 
		...
		<figure>
			<a href="<?php the_permalink(); ?>">
				<?php
 				$post_thumbnail_url = get_the_post_thumbnail($post->ID, 'newsmagz_blk_big_thumb' );
...
<?php } ?>
	...
	<div class="entry-content">
		...
		if ( $ismore ) : the_content( sprintf( esc_html__( 'Read more %s ...','newsmagz' ), '<span class="screen-reader-text">' . esc_html__( 'about ', 'newsmagz' ) . get_the_title() . '</span>' ) );
			else : echo newsmagz_excerpt(25);
