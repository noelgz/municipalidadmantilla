 ...
 * @return bool
 */
function newsmagz_isprevdem() {
	$tp_theme = wp_get_theme();
	$theme_name = $tp_theme ->get( 'TextDomain' );
	$active_theme = newsmagz_get_raw_option( 'template' );
	return apply_filters( 'newsmagz_isprevdem', ( $active_theme != strtolower( $theme_name ) ) );
}
 ...
 * @return bool|mixed
 */
function newsmagz_get_raw_option( $opt_name ) {
